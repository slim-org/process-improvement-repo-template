...
#### `trade-studies/trade-study-XYZ.md` [(source)](https://github.com/slim/[REPOSITORY_NAME_HERE]/blob/main/trade-studies/use-case-XYZ.md)
...
#### `starter-kits/starter-kit-XYZ/` [(source)](https://github.com/slim/[REPOSITORY_NAME_HERE]/blob/main/trade-studies/use-case-XYZ.md)
